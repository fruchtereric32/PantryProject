...
class ApiRequestBuilder:
    def __init__(self, main, hl, lc, hc):
        ...
        self.api_string = "https://api.edamam.com/search?q={main}&app_id={ai}&app_key={ak}&from=0&to=20&calories={l_c}-{h_c}".format(main=main, ai=self.app_id, ak=self.app_key, l_c=lc, h_c=hc)
        if len(hl) > 0:
            for itm in hl:
